...
{
	int bandera = SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE;//SDL_WINDOW_FULLSCREEN_DESKTOP SDL_WINDOWEVENT_RESTORED
	SDL_Window *ventana = SDL_CreateWindow("Concertista Midi", 0, 0, ANCHO, ALTO, bandera);
